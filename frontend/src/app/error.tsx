  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center bg-slate-50 p-6 text-slate-900 font-sans">
      <div className="max-w-2xl w-full relative group">
        ...
        <div className="relative bg-white backdrop-blur-xl border border-rose-500/30 rounded-2xl p-8 shadow-2xl space-y-6">
          ...
          <div className="space-y-3">
            ...
            {error?.message && (
              <div className="p-4 rounded-xl bg-slate-50 border border-slate-200 font-mono text-xs text-rose-300 space-y-1.5 overflow-x-auto">
          ...
          <div className="flex flex-wrap items-center gap-3 pt-4 border-t border-slate-200">
            <button
              onClick={() => reset()}
              className="px-5 py-2.5 rounded-xl bg-gradient-to-r from-rose-600 to-amber-600 text-slate-900 font-semibold text-sm shadow-lg shadow-rose-600/20 hover:from-rose-500 hover:to-amber-500 hover:scale-[1.02] active:scale-[0.98] transition flex items-center gap-2"
            >
            ...
            <Link
              href="/"
              className="px-5 py-2.5 rounded-xl bg-slate-100 text-slate-800 font-semibold text-sm border border-slate-200 hover:bg-slate-700 transition flex items-center gap-2"
            >
