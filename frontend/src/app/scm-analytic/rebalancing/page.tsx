...
export default function RebalancingPage() {
  ...
  return (
    <div id="export-container" className="space-y-8 max-w-[1550px] mx-auto pb-16 animate-in fade-in duration-500 text-foreground">
      ...
      {showHowTo && (
        <GlassCard className="no-export p-6 border-emerald-500/30 bg-card backdrop-blur-xl animate-fade-in">
          ...
          <div className="mt-6 p-4 bg-emerald-500/10 rounded-xl border border-emerald-500/20 text-xs text-muted-foreground">
      ...
      <div className="no-export space-y-3">
        <div className="flex items-center justify-between">
          ...
          <span className="text-xs text-muted-foreground italic hidden sm:inline">Klik tab untuk membandingkan ongkir termurah vs kecepatan kargo udara!</span>
        </div>
      ...
      <div className="no-export flex flex-col lg:flex-row lg:items-center justify-between gap-6 bg-card p-6 rounded-2xl border border-border shadow-xl relative z-30 overflow-visible mb-10">
        <div className="flex flex-col sm:flex-row sm:items-center gap-4 flex-1">
          <span className="text-xs font-bold text-muted-foreground uppercase tracking-wider whitespace-nowrap">Filter Entity / Cabang:</span>
